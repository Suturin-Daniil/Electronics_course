...
.PCB
[#img-pcb, caption="Figure 5: ", link=https://github.com/Suturin-Daniil/Electronics_course/blob/main/modules/ROOT/images/EasyEDA_PCB_scheme.png]
image::https://github.com/Suturin-Daniil/Electronics_course/blob/main/modules/ROOT/images/EasyEDA_PCB_scheme.png[pcb_scheme]

Также, импортировав из EasyEDA плату в .svg формате в CorelDraw, я нанес шелкографию для удобства в процессе пайки (Рис. 6)

.serigraphy
[#img-serigraphy, caption="Figure 6: ", link=https://github.com/Suturin-Daniil/Electronics_course/blob/main/modules/ROOT/images/EasyEDA_PCB_scheme.png]
image::https://github.com/Suturin-Daniil/Electronics_course/blob/main/modules/ROOT/images/EasyEDA_PCB_scheme.png[pcb_scheme]
